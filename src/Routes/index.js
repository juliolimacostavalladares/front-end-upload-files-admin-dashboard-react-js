...
class Routes extends Component {
  ...
  Upload = () => {
    ...
    return <Upload onUpload={this.handleUpload} files={uploadedFiles} />;
  };

  FileList = () => {
    const { uploadedFiles } = this.state;
    return <FileList files={uploadedFiles} onDelete={this.handleDelete} />;
  };
    ...
    return (
      <>
        ...
        {!!uploadedFiles.length && (
          <PrivateRoute path="/arquivos" component={this.FileList} />
        )}
